...
export default function ProjectDetail() {
    ...
    console.log("isDarkMode in ProjectDetail:", isDarkMode);
                    ...
                    <div className="max-w-7xl mx-auto">
                        <div className="mb-6">
                            <Button 
                                ...
                                onClick={() => navigate(-1)} 
                                className={`mb-4 ${isDarkMode ? 'border-gray-600 text-gray-200' : ''}`}
                            >
                                Back
                            </Button>

                            {/* Project Header Card */}
                            <Card className={`shadow-md border-l-4 border-l-blue-500 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white'}`}>
                                    ...
                                    <div className="flex-1">
                                        <div className="flex items-center space-x-3 mb-3">
                                            ...
                                            <div>
                                                <div className="flex items-center space-x-3">
                                                    <Title level={2} className={`m-0 ${isDarkMode ? 'text-white' : ''}`}>{project.project.name}</Title>
                                                    <Tag
                                                ...
                                                <Paragraph className={`mb-0 mt-1 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>{project.project.description}</Paragraph>
                                            </div>
                                        </div>
                                        ...
                                        <Space size="large" className="mt-4">
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <Text className={isDarkMode ? 'text-gray-300' : 'text-gray-500'}>Category:</Text>
                                                <Text strong className="uppercase">{project.project.category}</Text>
                                            </div>
                                            <div className="flex items-center space-x-2">
                                                <StarOutlined style={{ color: '#faad14' }} />
                                                <Text className={isDarkMode ? 'text-gray-300' : 'text-gray-500'}>Tags:</Text>
                            ...
                            <Row gutter={[16, 16]} className="mt-4">
                                <Col xs={24} sm={8}>
                                    <Card className={`shadow-sm text-center hover:shadow-md transition-shadow ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                                        <Space direction="vertical" size="small">
                                            <FileTextOutlined style={{ fontSize: 32, color: '#1890ff' }} />
                                            <Text className={isDarkMode ? 'text-gray-300' : 'text-gray-500'}>Total Issues</Text>
                                            <Title level={3} className={`m-0 ${isDarkMode ? 'text-white' : ''}`}>{totalIssues}</Title>
                                        </Space>
                                    </Card>
                                </Col>
                                <Col xs={24} sm={8}>
                                    <Card className={`shadow-sm text-center hover:shadow-md transition-shadow ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                                        <Space direction="vertical" size="small">
                                            ...
                                            <Text className={isDarkMode ? 'text-gray-300' : 'text-gray-500'}>Team Members</Text>
                                            <Title level={3} className={`m-0 ${isDarkMode ? 'text-white' : ''}`}>{totalMembers}</Title>
                                        </Space>
                                    </Card>
                                </Col>
                                <Col xs={24} sm={8}>
                                    <Card className={`shadow-sm text-center hover:shadow-md transition-shadow ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                                        <Space direction="vertical" size="small">
                                            ...
                                            <Text className={isDarkMode ? 'text-gray-300' : 'text-gray-500'}>Status Columns</Text>
                                            <Title level={3} className={`m-0 ${isDarkMode ? 'text-white' : ''}`}>{totalStatuses}</Title>
                                        </Space>
                                    </Card>
                                </Col>
                            </Row>
                        ...
                        <Row gutter={[24]}>
                            <Col xs={24}>
                                <Card
                                    ...
                                    className={`shadow-sm ${isDarkMode ? 'bg-gray-800' : ''}`}
                                >
                                                                                ...
                                                                                <Draggable key={issue.id} draggableId={issue.id} index={index}>
                                                                                    {(provided, snapshot) => (
                                                                                        <div
                                                                                            ...
                                                                                            className={`p-4 border-2 rounded-lg shadow-sm flex flex-col gap-2 relative transition-all hover:border-blue-300 ${snapshot.isDragging ? 'shadow-2xl rotate-2 border-blue-400' : ''
                                                                                                } ${isDarkMode ? 'bg-gray-600 border-gray-500 hover:border-blue-400' : 'bg-white'}`}
                                                                                            style={{
                                ...
                                <Card
                                    ...
                                    className={`shadow-sm mt-6 ${isDarkMode ? 'bg-gray-800' : ''}`}
                                >
                                    {Array.isArray(member) && member.length > 0 ? (
                                        <div className="space-y-3">
                                            {member.map((m, idx) => (
                                                <div
                                                    key={m.id || idx}
                                                    className={`flex items-center space-x-3 p-3 rounded-lg transition-colors border border-transparent hover:border-blue-200 ${isDarkMode ? 'hover:bg-gray-700 hover:border-blue-600' : 'hover:bg-gray-50'}`}
                                                >
                                                    <Avatar
                                                        size="large"
                                                        icon={<UserOutlined />}
                                        ...
                                        <Empty
                                            ...
                                            description={
                                                <div className="text-center">
                                                    <Text className={isDarkMode ? 'text-gray-300' : 'text-gray-500'}>No team members yet</Text>
                                                    <div className="mt-2">
                                                        <Button
                                                            type="primary"
                                                            icon={<UserAddOutlined />}
